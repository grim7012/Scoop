...
// // lib/flavors.ts (or wherever your flavors live)

// // export function buildFlavorContextSafe(query: string): string {
// //   try {
// //     // Decide source (default vs search)
// //     const source =
// //       !query || query.trim().length === 0
// //         ? flavors.slice(0, 5) // default small set
// //         : searchFlavors(query).slice(0, 5); // LIMIT results 🚀

// //     // Compact representation (LOW TOKENS ⚡)
// //     return source
// //       .map(
// //         (f) =>
// //           `${f.flavor_name} | mood:${f.mood_tag} | texture:${f.texture} | drink:${f.pairings.beverage} | intensity:${f.metrics.intensity}`
// //       )
// //       .join("\n");
// //   } catch (error) {
// //     console.error("Error in buildFlavorContext:", error);
...
export interface FlavorMetrics { sweetness: number; richness: number; umami: number; intensity: number; }
export interface FlavorPairings { beverage: string; topping: string; dessert: string; }
export interface DietaryFlags { vegan: boolean; gluten_free: boolean; nut_free: boolean; dairy_free: boolean; alcohol_free: boolean; egg_free: boolean; low_sugar:boolean; soy_free:boolean; halal:boolean; kosher:boolean; }
...
export const flavors: Flavor[] = [
  {
    ...
    sommelier_note: "Earthy truffle meets gentle sea salt and wildflower honey. Slow melt, long finish.",
    use_cases: ["romantic", "wine_pairing", "special_occasion"],
    dietary: { vegan: false, gluten_free: true, nut_free: true, dairy_free: false, alcohol_free: true, egg_free: false, low_sugar: false, soy_free: true, halal: false, kosher: false },
    avoid_with: ["citrus", "lemon", "orange juice"],
    serve_temp: "Slightly soft — rest 3 min before serving",
    texture: "Dense and velvety"
  },
  {
    ...
    sommelier_note: "Nutty brown butter meets miso caramel. Savory-sweet and completely addictive.",
    use_cases: ["whiskey_pairing", "bold_experiment", "chef_table"],
    dietary: { vegan: false, gluten_free: false, nut_free: true, dairy_free: false, alcohol_free: false, egg_free: false, low_sugar: false, soy_free: false, halal: false, kosher: false },
    avoid_with: ["citrus", "light fruit sorbets", "lemon"],
    serve_temp: "Slightly soft — best at room temp 2 min",
    texture: "Silky and rich"
  },
  {
    ...
    sommelier_note: "Cold brew clarity with a whisper of cardamom. Clean, aromatic, just right.",
    use_cases: ["coffee_pairing", "after_dinner", "afternoon_pickup"],
    dietary: { vegan: true, gluten_free: true, nut_free: true, dairy_free: true, alcohol_free: true, egg_free: true, low_sugar: false, soy_free: true, halal: true, kosher: true  },
    avoid_with: ["heavy dairy", "vanilla"],
    serve_temp: "Straight from freezer",
    texture: "Clean and smooth"
  },
  {
    ...
    sommelier_note: "Delicate floral lavender with honeycomb shards that shatter into sweetness.",
    use_cases: ["afternoon_tea", "romantic", "spring"],
    dietary: { vegan: false, gluten_free: true, nut_free: true, dairy_free: false, alcohol_free: true, egg_free: false, low_sugar: false, soy_free: true, halal: true, kosher: true },
    avoid_with: ["strong spices", "coffee", "citrus acids", "lemon"],
    serve_temp: "Slightly soft",
    texture: "Creamy with crunchy shards"
  },
  ...
  },
  {
    ...
    sommelier_note: "Tonka bean has this wild mix of vanilla, almond, and clove. Add smoked maple and it's a campfire in a scoop.",
    use_cases: ["whiskey_pairing", "autumn", "fireside"],
    dietary: { vegan: false, gluten_free: true, nut_free: false, dairy_free: false, alcohol_free: false, egg_free: false, low_sugar: false, soy_free: true, halal: false, kosher: false  },
    avoid_with: ["citrus", "light fruit", "tropical"],
    serve_temp: "Slightly soft",
    texture: "Velvety and smoky"
  },
  ...
  },
  {
    ...
    sommelier_note: "Yuzu's tart floral punch meets woodsy juniper. Wakes you right up.",
    use_cases: ["palate_cleanser", "cocktail_pairing", "summer"],
    dietary: { vegan: true, gluten_free: true, nut_free: true, dairy_free: true, alcohol_free: false, egg_free: true, low_sugar: false, soy_free: true, halal: true, kosher: true  },
    avoid_with: ["dairy", "rich caramel", "chocolate", "miso"],
    serve_temp: "Straight from freezer",
    texture: "Bright and icy"
  },
  ...
  },
  {
    ...
    sommelier_note: "Bronte pistachio with a whisper of rose water. Delicate, nutty, and just a little perfumed.",
    use_cases: ["romantic", "coffee_pairing", "middle_eastern_theme"],
    dietary: { vegan: false, gluten_free: true, nut_free: false, dairy_free: false, alcohol_free: true, egg_free: false, low_sugar: false, soy_free: true, halal: true, kosher: true  },
    avoid_with: ["coffee ice cream", "dark chocolate", "strong spice"],
    serve_temp: "Slightly soft",
    texture: "Creamy with crunch"
  },
  ...
  },
  {
    ...
    sommelier_note: "Brown sugar, Ceylon cinnamon, brioche crumbs. Like a warm hug in frozen form.",
    use_cases: ["brunch", "comfort_food", "coffee_pairing"],
    dietary: { vegan: false, gluten_free: false, nut_free: true, dairy_free: false, alcohol_free: true, egg_free: false, low_sugar: false, soy_free: true, halal: true, kosher: true  },
    avoid_with: ["citrus", "sour flavors", "tropical"],
    serve_temp: "Slightly soft",
    texture: "Buttery and comforting"
  },
  {
    ...
    sommelier_note: "Butterscotch with a savory miso backbone. It shouldn't work — but it absolutely does.",
    use_cases: ["bold_experiment", "beer_pairing", "autumn"],
    dietary: { vegan: false, gluten_free: false, nut_free: true, dairy_free: false, alcohol_free: true, egg_free: false , low_sugar: false, soy_free: false, halal: false, kosher: false  },
    avoid_with: ["citrus", "fruit sorbets", "tropical"],
    serve_temp: "Slightly soft",
    texture: "Silky and complex"
  },
  {
    ...
    sommelier_note: "Tangy goat cheese meets jammy, balsamic-kissed cherries. Light and surprisingly addictive.",
    use_cases: ["wine_pairing", "cheese_alternative", "elegant_gathering"],
    dietary: { vegan: false, gluten_free: true, nut_free: false, dairy_free: false, alcohol_free: true, egg_free: true, low_sugar: false, soy_free: true, halal: true, kosher: true  },
    avoid_with: ["chocolate", "heavy caramel", "milk"],
    serve_temp: "Slightly soft",
    texture: "Airy and light"
  },
...
export function searchFlavors(query: string): Flavor[] {
  if (!query || query.trim().length < 2) return flavors.slice(0, 3);
  ...
  const scored = flavors.map(f => {
    ...
    return {
      flavor: f,
      score: terms.reduce((s, t) => s + (blob.includes(t) ? 1 : 0), 0)
    };
  });
  ...
  // fallback if no hits
  return hits.length > 0 ? hits : flavors.slice(0, 3);
}
// Ultra-compact: ~60% fewer tokens. Only sent when user wants recs.
export function buildFlavorContext(query: string): string {
  return searchFlavors(query).map(f => {
    const diet = Object.entries(f.dietary || {}).filter(([, v]) => v).map(([k]) => k).join(",");
    return `${f.flavor_name}|${f.hex_color}|${f.image_url}|${f.mood_tag}|${f.texture}|${f.serve_temp}|drink:${f.pairings.beverage ?? "anything"}|top:${f.pairings.topping ?? "nothing"}${diet ? "|diet:"+diet : ""}|"${f.sommelier_note}"`;
  }).join("\n");
}

// Minimal name+hex list so AI can recommend flavors outside context
export function buildFlavorNameList(): string {
  return flavors.map(f => `${f.flavor_name} (${f.hex_color})`).join(", ");
}

// Detect recommendation intent — avoids sending flavor context for chat
export function isRecommendationRequest(msg: string): boolean {
  const lower = msg.toLowerCase().replace(/\[.*?\]/g, "").trim();
  if (lower.length < 4) return false;
  const conv = /^(hi|hey|hello|sup|yo|bye|thanks|thank you|ok|okay|cool|nice|great|what is|what's|explain|tell me about|how does|why is|i see|got it|interesting|sure|yes|no|maybe|what do you think|sounds)/;
  if (conv.test(lower)) return false;
  const rec = /(recommend|suggest|what should|looking for|want something|any.*flavor|good with|pair.*with|best for|something .*(romantic|bold|spicy|light|sweet|rich|refreshing|summer|winter|warm|cool|special)|surprise me|what.*try|show me|give me.*flavor|what.*good)/;
  return rec.test(lower);
}
